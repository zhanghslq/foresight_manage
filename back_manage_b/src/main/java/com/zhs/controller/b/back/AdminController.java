...
public class AdminController {
    ...
    public Result<Boolean> add(@RequestParam String username,@RequestParam String password,String realName,String mobile,Long roleId,@RequestParam(defaultValue = "0",required = false) Integer type){
